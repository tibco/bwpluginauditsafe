...
public class TctaAdapterFactory extends AdapterFactoryImpl
{
  ...
  /**
	...
	public Adapter createTctaAbstractObjectAdapter() {
		...
		/**
	 * Creates a new adapter for an object of class '{@link com.tibco.bw.palette.tas.model.tas.TctaGetToken <em>Get Token</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	public Adapter createTctaGetTokenAdapter() {
		...
		/**
	 * Creates a new adapter for an object of class '{@link com.tibco.bw.palette.tas.model.tas.TctaCreateTransaction <em>Create Transaction</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
