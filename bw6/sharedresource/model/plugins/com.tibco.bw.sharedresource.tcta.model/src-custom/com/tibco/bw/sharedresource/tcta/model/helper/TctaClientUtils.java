...
public class TctaClientUtils {
	...
	public static String requestCreateTransaction(String token,
			String tctaBaseUrl, String body) {
		String result = null;
		...
		String idmUrl = tctaBaseUrl + "/idm/v2/login-oauth";
		...
		try {
			...
			if(statusCode == HttpURLConnection.HTTP_OK){
				String transactionUrl = tctaBaseUrl + "/tcta/dataserver/transactions";
