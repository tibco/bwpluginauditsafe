...
public class TctaPackageImpl extends EPackageImpl implements TctaPackage
{
   ...
   * @generated
   */
  public EAttribute gettctaConnection_TextBox()
  {
   ...
   * @generated
   */
  public EAttribute gettctaConnection_Spinner()
  {
   ...
   * @generated
   */
  public EAttribute gettctaConnection_ComboViewer()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(tctaConnectionEClass, TCTA_CONNECTION__TEXT_BOX);
    createEAttribute(tctaConnectionEClass, TCTA_CONNECTION__SPINNER);
    createEAttribute(tctaConnectionEClass, TCTA_CONNECTION__COMBO_VIEWER);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(gettctaConnection_TextBox(), ecorePackage.getEString(), "textBox", null, 0, 1, tctaConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(gettctaConnection_Spinner(), ecorePackage.getEInt(), "spinner", null, 0, 1, tctaConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(gettctaConnection_ComboViewer(), ecorePackage.getEString(), "comboViewer", null, 0, 1, tctaConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
  ...
  /**
   * Initializes the annotations for <b>cbsharedresourceconfig</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  {
    String source = "cbsharedresourceconfig";			
    addAnnotation
      (tctaConnectionEClass, 
       source, 
       new String[] 
  ...
  protected void createCbgeneralcontrolAnnotations()
  {
    ...
    addAnnotation
      (gettctaConnection_TextBox(), 
       source, 
       new String[] 
       {
       "label", "TextBox : ",
       "type", "SRAttributeBindingField",
       "control", "TextBox"
       });			
    addAnnotation
      (gettctaConnection_Spinner(), 
       source, 
       new String[] 
       {
       "label", "Spinner :",
