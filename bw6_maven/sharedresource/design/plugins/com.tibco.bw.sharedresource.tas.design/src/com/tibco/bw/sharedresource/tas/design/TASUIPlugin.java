package com.tibco.bw.sharedresource.tas.design;
...
public class TASUIPlugin extends EclipseUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.tibco.bw.sharedresource.tas.design"; //$NON-NLS-1$

	// The shared instance
	private static TASUIPlugin plugin;
	 ...
	 */
	public static TASUIPlugin getDefault() {
		return plugin;
	}
